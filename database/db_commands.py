...
async def insert_message(tg_user_id: int, tg_message_id: int, text_data: str,
                         json_data: Any, get_error: int, label: str) -> None:
    """
    ...
    :param json_data: if error emerges for dump_json function
    :param get_error: error number to log
